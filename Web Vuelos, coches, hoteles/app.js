...
const airportCatalog = [
  ...
  ["Cuenca", "CUE", "Mariscal La Mar", "Ecuador"],
  ["Baltra Galápagos", "GPS", "Seymour Airport", "Ecuador"],
  ["San Cristóbal Galápagos", "SCY", "San Cristóbal Airport", "Ecuador"],
  ["Manta", "MEC", "Eloy Alfaro International", "Ecuador"],
  ["Loja", "LOH", "Ciudad de Catamayo", "Ecuador"],
  ["Francisco de Orellana", "OCC", "Francisco de Orellana Airport", "Ecuador"],
  ["Lago Agrio", "LGQ", "Nueva Loja Airport", "Ecuador"],
  ["Santa Rosa", "ETR", "Santa Rosa International", "Ecuador"],
  ["Esmeraldas", "ESM", "Carlos Concha Torres International", "Ecuador"],
  ["Latacunga", "LTX", "Cotopaxi International", "Ecuador"],
  ["Salinas", "SNC", "General Ulpiano Páez", "Ecuador"],
  ["Macas", "XMS", "Coronel Edmundo Carvajal", "Ecuador"],
  ["Tena", "TIA", "Jumandy Airport", "Ecuador"],
...
const translationExtras = {
  es: {
    hotelsCars: "Hoteles y coches", sortedPrices: "Precios ordenados", popularDestinations: "Destinos populares", popularDestinationsCopy: "Escapadas seleccionadas para viajar mejor y pagar menos.",
    airportSearchHelp: "Busca por ciudad, país, aeropuerto o código IATA", hotelSearchHelp: "Busca ciudad, zona o nombre de hotel", carSearchHelp: "Busca aeropuerto, estación, oficina o agencia", noSearchResults: "No hay resultados para esa búsqueda", youngDrivers: "Conductores menores de 25 años",
    availableAirports: "Aeropuertos disponibles", allCommercialAirports: "Todos los aeropuertos comerciales disponibles", destinationType: "Destino", inPrefix: "En", nearPrefix: "Cerca de",
    chooseTime: "Elige hora", combinedSavings: "Ahorro combinado", clearFare: "Tarifa clara", centralHotel: "Hotel céntrico", recommendedFlexible: "Flexible recomendado", completeEscape: "Escapada completa",
    economyCar: "Económico", familySuv: "SUV familiar", automaticPremium: "Premium automático", compactCar: "Compacto", directRecommended: "Directo recomendado",
    dayUnit: "día", daysUnit: "días", personUnit: "persona", peopleUnit: "personas", travelerUnit: "viajero", travelersUnit: "viajeros", passengerUnit: "pasajero", passengersUnit: "pasajeros", driverUnit: "conductor", driversUnit: "conductores", roomUnit: "habitación", roomsUnit: "habitaciones", childUnit: "niño", childrenUnit: "niños", adultUnit: "adulto", adultsUnit: "adultos",
    multiTitle: "Múltiples destinos", multiCopy: "Combina varios vuelos en una sola búsqueda", flightNumber: "Vuelo", remove: "Quitar", chooseOrigin: "Elige un lugar de salida", chooseDestination: "Elige el destino", addFlight: "Añadir otro vuelo", swapFlight: "Intercambiar vuelo", toConnector: "a",
    all: "Todos", language: "Idioma", flightOptions: "Opciones de vuelo", homeDocTitle: "Flyvero | Vuelos, hoteles y coches al mejor precio", resultsDocTitle: "Flyvero | Resultados", homeMeta: "Flyvero compara vuelos, hoteles, coches y paquetes con precios claros y buscadores adaptados a cada viaje.", resultsMeta: "Resultados de búsqueda Flyvero con vuelos, hoteles, coches y paquetes.",
  },
  en: {
    hotelsCars: "Hotels and cars", sortedPrices: "Sorted prices", popularDestinations: "Popular destinations", popularDestinationsCopy: "Selected escapes to travel better and pay less.",
    airportSearchHelp: "Search by city, country, airport or IATA code", hotelSearchHelp: "Search city, area or hotel name", carSearchHelp: "Search airport, station, office or agency", noSearchResults: "No results for that search", youngDrivers: "Drivers under 25",
    availableAirports: "Available airports", allCommercialAirports: "All available commercial airports", destinationType: "Destination", inPrefix: "In", nearPrefix: "Near",
    chooseTime: "Choose time", combinedSavings: "Combined saving", clearFare: "Clear fare", centralHotel: "Central hotel", recommendedFlexible: "Recommended flexible", completeEscape: "Complete getaway",
    economyCar: "Economy", familySuv: "Family SUV", automaticPremium: "Premium automatic", compactCar: "Compact", directRecommended: "Recommended direct",
    dayUnit: "day", daysUnit: "days", personUnit: "person", peopleUnit: "people", travelerUnit: "traveler", travelersUnit: "travelers", passengerUnit: "passenger", passengersUnit: "passengers", driverUnit: "driver", driversUnit: "drivers", roomUnit: "room", roomsUnit: "rooms", childUnit: "child", childrenUnit: "children", adultUnit: "adult", adultsUnit: "adults",
    multiTitle: "Multiple destinations", multiCopy: "Combine several flights in one search", flightNumber: "Flight", remove: "Remove", chooseOrigin: "Choose departure place", chooseDestination: "Choose destination", addFlight: "Add another flight", swapFlight: "Swap flight", toConnector: "to",
    all: "All", language: "Language", flightOptions: "Flight options", homeDocTitle: "Flyvero | Flights, hotels and cars at the best price", resultsDocTitle: "Flyvero | Results", homeMeta: "Flyvero compares flights, hotels, cars and packages with clear prices and search tools adapted to every trip.", resultsMeta: "Flyvero search results with flights, hotels, cars and packages.",
  },
  fr: {
    hotelsCars: "Hôtels et voitures", sortedPrices: "Prix triés", popularDestinations: "Destinations populaires", popularDestinationsCopy: "Escapades sélectionnées pour mieux voyager et payer moins.",
    airportSearchHelp: "Rechercher par ville, pays, aéroport ou code IATA", hotelSearchHelp: "Rechercher ville, quartier ou nom d'hôtel", carSearchHelp: "Rechercher aéroport, gare, agence ou bureau", noSearchResults: "Aucun résultat pour cette recherche", youngDrivers: "Conducteurs de moins de 25 ans",
    availableAirports: "Aéroports disponibles", allCommercialAirports: "Tous les aéroports commerciaux disponibles", destinationType: "Destination", inPrefix: "À", nearPrefix: "Près de",
    chooseTime: "Choisir l'heure", combinedSavings: "Économie combinée", clearFare: "Tarif clair", centralHotel: "Hôtel central", recommendedFlexible: "Flexible recommandé", completeEscape: "Séjour complet",
    economyCar: "Économique", familySuv: "SUV familial", automaticPremium: "Automatique premium", compactCar: "Compacte", directRecommended: "Direct recommandé",
    dayUnit: "jour", daysUnit: "jours", personUnit: "personne", peopleUnit: "personnes", travelerUnit: "voyageur", travelersUnit: "voyageurs", passengerUnit: "passager", passengersUnit: "passagers", driverUnit: "conducteur", driversUnit: "conducteurs", roomUnit: "chambre", roomsUnit: "chambres", childUnit: "enfant", childrenUnit: "enfants", adultUnit: "adulte", adultsUnit: "adultes",
    multiTitle: "Destinations multiples", multiCopy: "Combinez plusieurs vols en une seule recherche", flightNumber: "Vol", remove: "Retirer", chooseOrigin: "Choisir le lieu de départ", chooseDestination: "Choisir la destination", addFlight: "Ajouter un autre vol", swapFlight: "Échanger le vol", toConnector: "à",
    all: "Tous", language: "Langue", flightOptions: "Options de vol", homeDocTitle: "Flyvero | Vols, hôtels et voitures au meilleur prix", resultsDocTitle: "Flyvero | Résultats", homeMeta: "Flyvero compare vols, hôtels, voitures et forfaits avec des prix clairs et des moteurs adaptés à chaque voyage.", resultsMeta: "Résultats de recherche Flyvero avec vols, hôtels, voitures et forfaits.",
  },
  de: {
    hotelsCars: "Hotels und Autos", sortedPrices: "Sortierte Preise", popularDestinations: "Beliebte Ziele", popularDestinationsCopy: "Ausgewählte Kurztrips, um besser zu reisen und weniger zu zahlen.",
    airportSearchHelp: "Nach Stadt, Land, Flughafen oder IATA-Code suchen", hotelSearchHelp: "Stadt, Region oder Hotelname suchen", carSearchHelp: "Flughafen, Bahnhof, Station oder Anbieter suchen", noSearchResults: "Keine Ergebnisse für diese Suche", youngDrivers: "Fahrer unter 25",
    availableAirports: "Verfügbare Flughäfen", allCommercialAirports: "Alle verfügbaren Verkehrsflughäfen", destinationType: "Ziel", inPrefix: "In", nearPrefix: "In der Nähe von",
    chooseTime: "Uhrzeit wählen", combinedSavings: "Kombinierte Ersparnis", clearFare: "Klarer Tarif", centralHotel: "Zentrales Hotel", recommendedFlexible: "Flexibel empfohlen", completeEscape: "Komplette Reise",
    economyCar: "Economy", familySuv: "Familien-SUV", automaticPremium: "Premium-Automatik", compactCar: "Kompakt", directRecommended: "Direkt empfohlen",
    dayUnit: "Tag", daysUnit: "Tage", personUnit: "Person", peopleUnit: "Personen", travelerUnit: "Reisender", travelersUnit: "Reisende", passengerUnit: "Passagier", passengersUnit: "Passagiere", driverUnit: "Fahrer", driversUnit: "Fahrer", roomUnit: "Zimmer", roomsUnit: "Zimmer", childUnit: "Kind", childrenUnit: "Kinder", adultUnit: "Erwachsener", adultsUnit: "Erwachsene",
    multiTitle: "Mehrere Ziele", multiCopy: "Kombinieren Sie mehrere Flüge in einer Suche", flightNumber: "Flug", remove: "Entfernen", chooseOrigin: "Abflugort wählen", chooseDestination: "Ziel wählen", addFlight: "Weiteren Flug hinzufügen", swapFlight: "Flug tauschen", toConnector: "nach",
    all: "Alle", language: "Sprache", flightOptions: "Flugoptionen", homeDocTitle: "Flyvero | Flüge, Hotels und Autos zum besten Preis", resultsDocTitle: "Flyvero | Ergebnisse", homeMeta: "Flyvero vergleicht Flüge, Hotels, Mietwagen und Pakete mit klaren Preisen und passenden Suchtools für jede Reise.", resultsMeta: "Flyvero-Suchergebnisse mit Flügen, Hotels, Autos und Paketen.",
  },
  it: {
    hotelsCars: "Hotel e auto", sortedPrices: "Prezzi ordinati", popularDestinations: "Destinazioni popolari", popularDestinationsCopy: "Fughe selezionate per viaggiare meglio e pagare meno.",
    airportSearchHelp: "Cerca per città, paese, aeroporto o codice IATA", hotelSearchHelp: "Cerca città, zona o nome hotel", carSearchHelp: "Cerca aeroporto, stazione, ufficio o agenzia", noSearchResults: "Nessun risultato per questa ricerca", youngDrivers: "Conducenti sotto i 25 anni",
    availableAirports: "Aeroporti disponibili", allCommercialAirports: "Tutti gli aeroporti commerciali disponibili", destinationType: "Destinazione", inPrefix: "In", nearPrefix: "Vicino a",
    chooseTime: "Scegli ora", combinedSavings: "Risparmio combinato", clearFare: "Tariffa chiara", centralHotel: "Hotel centrale", recommendedFlexible: "Flessibile consigliato", completeEscape: "Vacanza completa",
    economyCar: "Economica", familySuv: "SUV familiare", automaticPremium: "Automatico premium", compactCar: "Compatta", directRecommended: "Diretto consigliato",
    dayUnit: "giorno", daysUnit: "giorni", personUnit: "persona", peopleUnit: "persone", travelerUnit: "viaggiatore", travelersUnit: "viaggiatori", passengerUnit: "passeggero", passengersUnit: "passeggeri", driverUnit: "conducente", driversUnit: "conducenti", roomUnit: "camera", roomsUnit: "camere", childUnit: "bambino", childrenUnit: "bambini", adultUnit: "adulto", adultsUnit: "adulti",
    multiTitle: "Destinazioni multiple", multiCopy: "Combina più voli in una sola ricerca", flightNumber: "Volo", remove: "Rimuovi", chooseOrigin: "Scegli luogo di partenza", chooseDestination: "Scegli destinazione", addFlight: "Aggiungi un altro volo", swapFlight: "Scambia volo", toConnector: "a",
    all: "Tutti", language: "Lingua", flightOptions: "Opzioni volo", homeDocTitle: "Flyvero | Voli, hotel e auto al miglior prezzo", resultsDocTitle: "Flyvero | Risultati", homeMeta: "Flyvero confronta voli, hotel, auto e pacchetti con prezzi chiari e motori adattati a ogni viaggio.", resultsMeta: "Risultati di ricerca Flyvero con voli, hotel, auto e pacchetti.",
  },
};

Object.entries(translationExtras).forEach(([lang, values]) => Object.assign(translations[lang], values));
...
function plural(count, oneKey, manyKey) {
  return `${count} ${t(count === 1 ? oneKey : manyKey)}`;
}
...
function localizeText(value) {
  ...
  const replacements = {
    en: {
      "España": "Spain", "Francia": "France", "Alemania": "Germany", "Italia": "Italy", "Reino Unido": "United Kingdom", "Estados Unidos": "United States", "Países Bajos": "Netherlands", "Suiza": "Switzerland", "México": "Mexico", "Chile": "Chile",
      "Agencia de alquiler de coches": "Car rental agency", "Oficinas de alquiler en": "Rental offices at", "Alquiler de coches en zona centro": "Car rental in the city centre", "Estación de tren": "Train station", "Comunidad de Madrid": "Madrid Region", "Andalucía": "Andalusia", "Cataluña": "Catalonia", "Islas Baleares": "Balearic Islands", "Canarias": "Canary Islands", "Todos": "All",
    },
    fr: {
      "España": "Espagne", "Francia": "France", "Alemania": "Allemagne", "Italia": "Italie", "Reino Unido": "Royaume-Uni", "Estados Unidos": "États-Unis", "Países Bajos": "Pays-Bas", "Suiza": "Suisse", "México": "Mexique", "Chile": "Chili",
      "Agencia de alquiler de coches": "Agence de location de voitures", "Oficinas de alquiler en": "Agences de location à", "Alquiler de coches en zona centro": "Location de voitures en centre-ville", "Estación de tren": "Gare", "Comunidad de Madrid": "Communauté de Madrid", "Andalucía": "Andalousie", "Cataluña": "Catalogne", "Islas Baleares": "Îles Baléares", "Canarias": "Îles Canaries", "Todos": "Tous",
    },
    de: {
      "España": "Spanien", "Francia": "Frankreich", "Alemania": "Deutschland", "Italia": "Italien", "Reino Unido": "Vereinigtes Königreich", "Estados Unidos": "Vereinigte Staaten", "Países Bajos": "Niederlande", "Suiza": "Schweiz", "México": "Mexiko", "Chile": "Chile",
      "Agencia de alquiler de coches": "Mietwagenanbieter", "Oficinas de alquiler en": "Mietwagenstationen in", "Alquiler de coches en zona centro": "Mietwagen im Stadtzentrum", "Estación de tren": "Bahnhof", "Comunidad de Madrid": "Region Madrid", "Andalucía": "Andalusien", "Cataluña": "Katalonien", "Islas Baleares": "Balearen", "Canarias": "Kanarische Inseln", "Todos": "Alle",
    },
    it: {
      "España": "Spagna", "Francia": "Francia", "Alemania": "Germania", "Italia": "Italia", "Reino Unido": "Regno Unito", "Estados Unidos": "Stati Uniti", "Países Bajos": "Paesi Bassi", "Suiza": "Svizzera", "México": "Messico", "Chile": "Cile",
      "Agencia de alquiler de coches": "Agenzia di autonoleggio", "Oficinas de alquiler en": "Uffici di noleggio a", "Alquiler de coches en zona centro": "Noleggio auto in centro", "Estación de tren": "Stazione ferroviaria", "Comunidad de Madrid": "Comunità di Madrid", "Andalucía": "Andalusia", "Cataluña": "Catalogna", "Islas Baleares": "Isole Baleari", "Canarias": "Isole Canarie", "Todos": "Tutti",
    },
  }[currentLang];
...
const carState = { pickupTime: "", returnTime: "", age25to70: true, youngDriver: false, youngDriverAge: "24", differentOffice: false };
const multiFlights = [
...
if (location.hash === "#search" && history.replaceState) {
...
function applyStaticTranslations() {
  ...
  if (pathName.includes("privacidad")) document.title = `${t("privacyTitle")} | Flyvero`;
  else if (pathName.includes("afiliados")) document.title = `${t("affiliateTitle")} | Flyvero`;
  else if (pathName.includes("terminos")) document.title = `${t("termsTitle")} | Flyvero`;
  else if (pathName.includes("cookies")) document.title = `${t("cookiesTitle")} | Flyvero`;
  else document.title = isResultsPage ? t("resultsDocTitle") : t("homeDocTitle");
  const metaDescription = document.querySelector('meta[name="description"]');
  if (metaDescription) {
    const metaText = pathName.includes("privacidad")
      ? t("privacyIntro")
  ...
  const navMap = isResultsPage
    ...
    : document.querySelector("[data-nav-product]")
      ? [
  ...
  if (highlights[1]) highlights[1].textContent = t("hotelsCars");
  if (highlights[2]) highlights[2].textContent = t("sortedPrices");
  ...
  if (sectionHead) sectionHead.textContent = t("popularDestinations");
  const sectionCopy = document.querySelector("#hotels .section-head > p");
  if (sectionCopy) sectionCopy.textContent = t("popularDestinationsCopy");
  ...
  const destinationTexts = {
    es: [["París", "Escapadas urbanas y hoteles céntricos.", "Desde 49 €"], ["Madrid", "Vuelos, hoteles y coches para trabajo o ocio.", "Desde 38 €"], ["Dubái", "Hoteles premium y larga distancia.", "Desde 189 €"]],
    en: [["Paris", "City breaks and central hotels.", "From €49"], ["Madrid", "Flights, hotels and cars for work or leisure.", "From €38"], ["Dubai", "Premium hotels and long-haul trips.", "From €189"]],
    fr: [["Paris", "Escapades urbaines et hôtels centraux.", "Dès 49 €"], ["Madrid", "Vols, hôtels et voitures pour travail ou loisirs.", "Dès 38 €"], ["Dubaï", "Hôtels premium et longue distance.", "Dès 189 €"]],
    de: [["Paris", "Städtereisen und zentrale Hotels.", "Ab 49 €"], ["Madrid", "Flüge, Hotels und Autos für Arbeit oder Freizeit.", "Ab 38 €"], ["Dubai", "Premium-Hotels und Langstrecke.", "Ab 189 €"]],
    it: [["Parigi", "City break e hotel centrali.", "Da 49 €"], ["Madrid", "Voli, hotel e auto per lavoro o piacere.", "Da 38 €"], ["Dubai", "Hotel premium e lunga distanza.", "Da 189 €"]],
  }[currentLang];
  destinations.forEach((card, index) => {
    if (!destinationTexts?.[index]) return;
    const [title, copy, price] = destinationTexts[index];
    const h3 = card.querySelector("h3");
    const p = card.querySelector("p");
  ...
  const guideHead = document.querySelector("#guides .section-head h2");
  const guideEyebrow = document.querySelector("#guides .eyebrow");
  if (guideEyebrow) guideEyebrow.textContent = { es: "Guías Flyvero", en: "Flyvero guides", fr: "Guides Flyvero", de: "Flyvero-Reiseführer", it: "Guide Flyvero" }[currentLang];
  if (guideHead) guideHead.textContent = { es: "Ideas para tu próximo viaje", en: "Ideas for your next trip", fr: "Idées pour votre prochain voyage", de: "Ideen für Ihre nächste Reise", it: "Idee per il tuo prossimo viaggio" }[currentLang];
  const guides = document.querySelectorAll(".guide-grid article");
  const guideTexts = {
    es: [["Vuelos", "Vuelos baratos desde Espana", "Compara aeropuertos, horarios y fechas para encontrar mejores precios."], ["Fechas", "Mejor mes para viajar a Paris", "Clima, demanda hotelera y fines de semana recomendados."], ["Hoteles", "Hoteles baratos en Madrid", "Zonas, habitaciones y fechas para ajustar mejor el presupuesto."], ["Coches", "Alquiler de coches en Espana", "Recogida, devolucion, conductores jovenes y extras familiares."], ["Paquetes", "Vuelo + hotel: cuando ahorrar", "Compara paquetes frente a reservas separadas para ver el coste total."], ["Escapadas", "Escapadas de fin de semana", "Ideas de destinos cortos desde Espana con vuelo, hotel y coche."]],
    en: [["Flights", "Cheap flights from Spain", "Compare airports, times and dates to find better prices."], ["Dates", "Best month to travel to Paris", "Weather, hotel demand and recommended weekends."], ["Hotels", "Cheap hotels in Madrid", "Areas, rooms and dates to control the budget."], ["Cars", "Car hire in Spain", "Pick-up, return, young drivers and family extras."], ["Packages", "Flight + hotel: when to save", "Compare packages with separate bookings to see the total cost."], ["Getaways", "Weekend getaways", "Short-trip ideas from Spain with flight, hotel and car."]],
    fr: [["Vols", "Vols pas chers depuis l'Espagne", "Comparez aeroports, horaires et dates pour trouver de meilleurs prix."], ["Dates", "Meilleur mois pour voyager a Paris", "Climat, demande hoteliere et week-ends recommandes."], ["Hotels", "Hotels pas chers a Madrid", "Quartiers, chambres et dates pour ajuster le budget."], ["Voitures", "Location de voitures en Espagne", "Prise en charge, retour, jeunes conducteurs et extras famille."], ["Forfaits", "Vol + hotel: quand economiser", "Comparez forfaits et reservations separees pour voir le cout total."], ["Escapades", "Escapades de week-end", "Idees de courts sejours depuis l'Espagne avec vol, hotel et voiture."]],
    de: [["Fluge", "Gunstige Fluge ab Spanien", "Vergleichen Sie Flughafen, Zeiten und Daten fur bessere Preise."], ["Daten", "Bester Monat fur Paris", "Wetter, Hotelnachfrage und empfohlene Wochenenden."], ["Hotels", "Gunstige Hotels in Madrid", "Lagen, Zimmer und Daten fur ein besseres Budget."], ["Autos", "Mietwagen in Spanien", "Abholung, Ruckgabe, junge Fahrer und Familienextras."], ["Pakete", "Flug + Hotel: wann sparen", "Vergleichen Sie Pakete mit Einzelbuchungen, um die Gesamtkosten zu sehen."], ["Kurztrips", "Wochenendtrips", "Ideen fur kurze Reisen ab Spanien mit Flug, Hotel und Auto."]],
    it: [["Voli", "Voli economici dalla Spagna", "Confronta aeroporti, orari e date per trovare prezzi migliori."], ["Date", "Mese migliore per Parigi", "Clima, domanda hotel e weekend consigliati."], ["Hotel", "Hotel economici a Madrid", "Zone, camere e date per controllare il budget."], ["Auto", "Noleggio auto in Spagna", "Ritiro, riconsegna, conducenti giovani ed extra famiglia."], ["Pacchetti", "Volo + hotel: quando risparmiare", "Confronta pacchetti e prenotazioni separate per vedere il costo totale."], ["Weekend", "Fughe del weekend", "Idee per viaggi brevi dalla Spagna con volo, hotel e auto."]],
  }[currentLang];
  guides.forEach((card, index) => {
    if (!guideTexts?.[index]) return;
    const [tag, title, copy] = guideTexts[index];
  ...
  if (footerLinks[4]) footerLinks[4].textContent = t("affiliates");
  if (footerLinks[5]) footerLinks[5].textContent = t("terms");
}
...
const airportSearchAliases = {
  UIO: "ecuador quito pichincha tababela mariscal sucre",
  GYE: "ecuador guayaquil guayas jose joaquin olmedo",
  CUE: "ecuador cuenca azuay mariscal la mar",
  GPS: "ecuador galapagos baltra islas galapagos seymour",
  SCY: "ecuador galapagos san cristobal islas galapagos",
  MEC: "ecuador manta manabi eloy alfaro",
  LOH: "ecuador loja catamayo ciudad de catamayo",
  OCC: "ecuador coca francisco de orellana orellana",
  LGQ: "ecuador lago agrio nueva loja sucumbios",
  ETR: "ecuador santa rosa el oro",
  ESM: "ecuador esmeraldas carlos concha torres",
  LTX: "ecuador latacunga cotopaxi",
  SNC: "ecuador salinas santa elena general ulpiano paez",
  XMS: "ecuador macas morona santiago",
  TIA: "ecuador tena napo jumandy",
...
const airportDestinationGroups = [
  { key: "ecuador", title: "Ecuador", codes: ["UIO", "GYE", "CUE", "GPS", "SCY", "MEC", "LOH", "OCC", "LGQ", "ETR", "ESM", "LTX", "SNC", "XMS", "TIA"] },
  { key: "galapagos", title: "Galápagos", codes: ["GPS", "SCY"] },
  { key: "islas galapagos", title: "Galápagos", codes: ["GPS", "SCY"] },
...
function airportDetail(airport) {
  return localizeText(`${airport.name} · ${airport.city}, ${airport.country}`);
}
...
function renderPlaceButton(place) {
  const typeLabels = {
    ciudad: { es: "Ciudad", en: "City", fr: "Ville", de: "Stadt", it: "Città" },
    zona: { es: "Zona", en: "Area", fr: "Zone", de: "Gebiet", it: "Zona" },
    hotel: { es: "Hotel", en: "Hotel", fr: "Hôtel", de: "Hotel", it: "Hotel" },
    isla: { es: "Isla", en: "Island", fr: "Île", de: "Insel", it: "Isola" },
    aeropuerto: { es: "Aeropuerto", en: "Airport", fr: "Aéroport", de: "Flughafen", it: "Aeroporto" },
    estación: { es: "Estación", en: "Station", fr: "Gare", de: "Station", it: "Stazione" },
    oficina: { es: "Oficina", en: "Office", fr: "Bureau", de: "Station", it: "Ufficio" },
    agencia: { es: "Agencia", en: "Agency", fr: "Agence", de: "Anbieter", it: "Agenzia" },
  };
  return `
    <button type="button" class="suggest-item place-suggest" data-value="${place.title}">
      <span class="suggest-main"><strong>${localizeText(place.title)}</strong><span>${localizeText(place.detail)}</span></span>
      <span class="suggest-type">${typeLabels[place.type]?.[currentLang] || typeLabels[place.type]?.es || place.type}</span>
    </button>
  `;
}
...
function renderPlaceGroups(items, kind) {
  ...
  return order
    ...
    .join("") || `<div class="suggest-empty">${t("noSearchResults")}</div>`;
}
...
function renderAirportGroups(value, items, nearby) {
  ...
  if (destinationGroup) {
    ...
    if (primary) {
      destinationRows = renderGroup(t("destinationType"), [`
        <button type="button" class="suggest-item destination-suggest" data-value="${label(primary)}">
          <span class="suggest-main"><strong>${localizeText(destinationGroup.title)}</strong><span>${t("allCommercialAirports")}</span></span>
          <span class="suggest-type">${t("destinationType")}</span>
        </button>
      `]);
    }
    ...
    destinationRows = renderGroup(t("destinationType"), [`
      <button type="button" class="suggest-item destination-suggest" data-value="${label(primary)}">
        <span class="suggest-main"><strong>${primary.city} (${t("all")})</strong><span>${localizeText(primary.country)}</span></span>
        <span class="suggest-type">${t("destinationType")}</span>
      </button>
    `]);
  }
  ...
  const title = destinationGroup
    ? `${t("inPrefix")} ${localizeText(destinationGroup.title)}`
    : nearby.length > 1
      ? `${t("nearPrefix")} ${nearby[0].city}`
      : exactCountry
        ? `${t("inPrefix")} ${localizeText(airportRows[0].country)}`
        : t("availableAirports");
...
function timeOptions(selected) {
  const values = [`<option value="" ${selected ? "" : "selected"} disabled>${t("chooseTime")}</option>`];
...
function getCriteria() {
  return {
    ...
    travelers: els.travelers?.value || plural(1, "travelerUnit", "travelersUnit"),
    tripType,
...
function criteriaToParams() {
  ...
  return new URLSearchParams({
    ...
    youngDriver: carState.youngDriver ? "1" : "0",
...
function applyCriteriaFromUrl() {
  ...
  if (params.has("youngDriver")) carState.youngDriver = params.get("youngDriver") === "1";
...
function updateOverlayState() {
  ...
  const hasSuggestPanel = [els.originSuggest, els.destSuggest].some((panel) => panel && !panel.hidden);
  document.body.classList.toggle("flyvero-overlay-open", hasOpenPanel);
  document.body.classList.toggle("flyvero-suggest-open", hasSuggestPanel);
}
...
function positionSuggestPanel(input, panel) {
  ...
  const rect = group?.getBoundingClientRect() || input.getBoundingClientRect();
  const width = Math.min(650, window.innerWidth - 32);
  const opensRight = rect.left + width <= window.innerWidth - 16;
  const availableBelow = window.innerHeight - rect.bottom - 18;
  panel.style.position = "absolute";
  panel.style.left = opensRight ? "0" : "auto";
  panel.style.right = opensRight ? "auto" : "0";
  panel.style.top = "calc(100% + 8px)";
  panel.style.bottom = "auto";
  panel.style.width = `${width}px`;
  panel.style.maxHeight = `${Math.max(240, Math.min(520, availableBelow))}px`;
}
...
function renderSuggest(input, panel) {
  ...
  if (product === "hotel" || (product === "package" && input === els.dest)) {
    ...
    panel.innerHTML = `
      <div class="suggest-head"><strong>${t("hotelDestination")}</strong><span>${t("hotelSearchHelp")}</span></div>
  ...
  if (product === "car") {
    ...
    panel.innerHTML = `
      <div class="suggest-head"><strong>${input === els.dest ? t("returnOffice") : t("pickup")}</strong><span>${t("carSearchHelp")}</span></div>
  ...
  panel.innerHTML = `
    <div class="suggest-head compact"><strong>${t("airport")}</strong><span>${t("airportSearchHelp")}</span></div>
...
function updateTravelerText() {
  const adultText = plural(travelerState.adults, "adultUnit", "adultsUnit");
  const childText = plural(travelerState.children, "childUnit", "childrenUnit");
  const people = travelerState.adults + travelerState.children;
  let title = `${adultText}, ${childText}`;
  let subtitle = plural(people, "passengerUnit", "passengersUnit");
  if (product === "hotel") {
    title = `${adultText}, ${childText}`;
    subtitle = `${plural(people, "personUnit", "peopleUnit")}, ${plural(travelerState.rooms, "roomUnit", "roomsUnit")}`;
  ...
  if (product === "package") {
    ...
    title = `${adultText}, ${childText}`;
    subtitle = `${plural(packagePeople, "travelerUnit", "travelersUnit")}, ${plural(travelerState.rooms, "roomUnit", "roomsUnit")}`;
  }
  if (product === "flight") title = `${adultText}, ${childText}`;
  if (product === "car") {
    title = plural(travelerState.drivers, "driverUnit", "driversUnit");
  ...
  if (els.priceLegend) {
    if (product === "flight") {
      els.priceLegend.innerHTML = `
        <div class="calendar-trip-switch" role="group" aria-label="${t("flightOptions")}">
...
function buildOffers() {
  ...
  const providers =
    product === "hotel"
      ...
      : product === "car"
        ? [t("economyCar"), t("familySuv"), t("automaticPremium"), t("compactCar")]
        : product === "package"
          ? [t("packageDeals"), t("centralHotel"), t("recommendedFlexible"), t("completeEscape")]
          : [t("directRecommended"), t("bestPrice"), t("goodTime"), t("clearFare")];
      ...
      product === "flight"
        ...
        : product === "hotel"
          ...
          : product === "car"
            ...
            : [t("package"), t("combinedSavings"), t("topRated"), t("flexibleMonth")][index];
    ...
    ? offers.map((offer, index) => `
      <article class="offer-card">
        <div class="offer-left">
          ...
          <div>
            <h3>${offer.name} - ${product === "hotel" ? offer.to.city : `${offer.from.city} ${t("toConnector")} ${offer.to.city}`}</h3>
            <div class="offer-meta">
              <span>${offer.meta}</span>
              <span>${product === "flight" ? `${Math.floor(offer.duration / 60)}h ${offer.duration % 60}m` : plural(offer.duration, "dayUnit", "daysUnit")}</span>
...
function renderMultiCityPanel() {
  ...
  els.multiCityPanel.innerHTML = `
    <div class="multi-city-head">
      ...
      <span>${t("multiCopy")}</span>
    </div>
    ${multiFlights.map((flight, index) => `
      <section class="multi-flight-card" data-index="${index}">
        <div class="multi-flight-title">
          <strong>${t("flightNumber")} ${index + 1}</strong>
          ${multiFlights.length > 2 ? `<button type="button" class="multi-remove" data-remove-flight="${index}">${t("remove")}</button>` : ""}
        </div>
        <label class="multi-row">
          <span class="multi-icon">O</span>
          <input data-multi-field="from" data-index="${index}" value="${flight.from}" placeholder="${t("chooseOrigin")}" autocomplete="off" />
        </label>
        <label class="multi-row">
          <span class="multi-icon">D</span>
          <input data-multi-field="to" data-index="${index}" value="${flight.to}" placeholder="${t("chooseDestination")}" autocomplete="off" />
          <button type="button" class="multi-swap" data-swap-flight="${index}" aria-label="${t("swapFlight")} ${index + 1}">&lt;&gt;</button>
        </label>
        <label class="multi-row">
    ...
    `).join("")}
    <button type="button" class="add-flight-btn" id="addFlightBtn">+ ${t("addFlight")}</button>
  `;
}
...
document.querySelectorAll('a[href="#guides"]').forEach((link) => link.addEventListener("click", (event) => {
  event.preventDefault();
  document.querySelector("#guides")?.scrollIntoView({ behavior: "smooth", block: "start" });
  if (history.replaceState) history.replaceState(null, "", `${location.pathname}${location.search}`);
}));
els.productNavLinks.forEach((link) => link.addEventListener("click", (event) => {
  event.preventDefault();
  ...
  els.productExtraOptions.innerHTML = `
    ...
    <div class="car-option-row">
      <label class="extra-check return-office-toggle">
        ...
        <span>${t("differentOffice")}</span>
      </label>
      <label class="extra-check young-driver-toggle">
        <input type="checkbox" data-car-extra="youngDriver" ${carState.youngDriver ? "checked" : ""} />
        <span>${t("youngDrivers")}</span>
      </label>
    </div>
