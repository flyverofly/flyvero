...
const translationExtras = {
  es: {
    ...
    airportSearchHelp: "Busca por ciudad, país, aeropuerto o código IATA", hotelSearchHelp: "Busca ciudad, zona o nombre de hotel", carSearchHelp: "Busca aeropuerto, estación, oficina o agencia", noSearchResults: "No hay resultados para esa búsqueda",
  ...
  en: {
    ...
    airportSearchHelp: "Search by city, country, airport or IATA code", hotelSearchHelp: "Search city, area or hotel name", carSearchHelp: "Search airport, station, office or agency", noSearchResults: "No results for that search",
  ...
  fr: {
    ...
    airportSearchHelp: "Rechercher par ville, pays, aéroport ou code IATA", hotelSearchHelp: "Rechercher ville, quartier ou nom d'hôtel", carSearchHelp: "Rechercher aéroport, gare, agence ou bureau", noSearchResults: "Aucun résultat pour cette recherche",
  ...
  de: {
    ...
    airportSearchHelp: "Nach Stadt, Land, Flughafen oder IATA-Code suchen", hotelSearchHelp: "Stadt, Region oder Hotelname suchen", carSearchHelp: "Flughafen, Bahnhof, Station oder Anbieter suchen", noSearchResults: "Keine Ergebnisse für diese Suche",
  ...
  it: {
    ...
    airportSearchHelp: "Cerca per città, paese, aeroporto o codice IATA", hotelSearchHelp: "Cerca città, zona o nome hotel", carSearchHelp: "Cerca aeroporto, stazione, ufficio o agenzia", noSearchResults: "Nessun risultato per questa ricerca",
...
function applyStaticTranslations() {
  ...
  const guideTexts = {
    es: [["Vuelos", "Vuelos baratos desde Barcelona", "Compara El Prat, Girona y Reus para encontrar mejores precios."], ["Fechas", "Mejor mes para viajar a París", "Clima, demanda y fines de semana recomendados."], ["Coches", "Ruta por la Costa del Sol", "Vuelo, hotel y coche para escapadas desde España."]],
    en: [["Flights", "Cheap flights from Barcelona", "Compare El Prat, Girona and Reus to find better prices."], ["Dates", "Best month to travel to Paris", "Weather, demand and recommended weekends."], ["Cars", "Costa del Sol road trip", "Flight, hotel and car for getaways from Spain."]],
    fr: [["Vols", "Vols pas chers depuis Barcelone", "Comparez El Prat, Gérone et Reus pour trouver de meilleurs prix."], ["Dates", "Meilleur mois pour voyager à Paris", "Climat, demande et week-ends recommandés."], ["Voitures", "Route sur la Costa del Sol", "Vol, hôtel et voiture pour escapades depuis l'Espagne."]],
    de: [["Flüge", "Günstige Flüge ab Barcelona", "Vergleichen Sie El Prat, Girona und Reus für bessere Preise."], ["Daten", "Bester Monat für Paris", "Wetter, Nachfrage und empfohlene Wochenenden."], ["Autos", "Route an der Costa del Sol", "Flug, Hotel und Auto für Kurztrips ab Spanien."]],
    it: [["Voli", "Voli economici da Barcellona", "Confronta El Prat, Girona e Reus per trovare prezzi migliori."], ["Date", "Mese migliore per Parigi", "Clima, domanda e weekend consigliati."], ["Auto", "Itinerario Costa del Sol", "Volo, hotel e auto per fughe dalla Spagna."]],
  }[currentLang];
